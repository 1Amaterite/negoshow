...
export default function CheckerPage() {
  ...
  if (checkerStep === "result" && checkResult && checkerCommodity) {
    ...
    return (
      <div>
        <PageHeader title="Resulta ng Suriin" subtitle={`${checkerCommodity.tagalog} · ${checkerLocation}`} />
  ...
  return (
    <div>
      <PageHeader title="Suriin ang Presyo" subtitle="I-check kung patas ang quote ng middleman" onBack={() => router.push("/")} />
