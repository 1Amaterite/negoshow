        ...
        {tab==="overview" && <>
          <div className="procurement-kpis">
            <div className="group relative cursor-help">
              ...
              <div className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50 w-64 p-4 bg-gray-900 text-gray-100 text-[12px] rounded-xl shadow-2xl left-1/2 -translate-x-1/2 top-full mt-3 border border-gray-700 hidden sm:block">
                <div className="mb-2.5">
                  <span className="text-white font-bold block mb-1 text-[10px] uppercase tracking-widest">{lang === 'tl' ? 'Layunin' : 'Purpose'}</span>
                  <p className="leading-relaxed">{(t.procurement.kpis as any).savingsPurpose}</p>
                </div>
                <div>
                  <span className="text-white font-bold block mb-1 text-[10px] uppercase tracking-widest">{lang === 'tl' ? 'Kalkulasyon' : 'Computation'}</span>
